...
function rejectionComment(type, numFailures) {
  var choices;
  if (numFailures <= 1) {
    var helpAnchor = (type === 'simple') ?
        'simple-quotes' : 'multi-speaker-quotes';
    choices = [
      'Sorry, I can\'t quite understand your quote. Can you put it in a form ' +
          'I can read? See http://github.com/Asana/node-quotana#' + helpAnchor +
