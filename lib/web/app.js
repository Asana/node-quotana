...
function App(options) {
  ...
  // @type {String[]} Sources of quotes to filter to
  me.source = null;
}
...
App.prototype.reloadParameters = function() {
  var me = this;
  var parameters = {};
  ...
  me.source = parameters.source ? parameters.source : null;
  me.reset();
};
...
App.prototype.reset = function() {
  ...
  var filteredQuotes = (me.source === null) ?
      me.allQuotes :
      me.allQuotes.filter(function(quote) {
        return quote.source === me.source;
      });
