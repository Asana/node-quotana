...
QuoteStore.prototype.load = function() {
  ...
  return new Bluebird(function(resolve, reject) {
    ...
    // Subscribe to changes in quotes
    me.client.events.stream(me.options.id)
...
// TODO: refactor listener and this to use same common logic

QuoteStore.prototype._onEvent = function(event) {
  // When the listener (Quoticorn) has approved a quote he always makes
  // some kind of a change, like a comment.
